...
reddit_p = praw.Reddit(client_id='your client id here',
...
for i_bpt, image_bpt in enumerate(bpt_urls, start=1):
	urllib.request.urlretrieve(image_bpt, r"C:\Users\ethan\Desktop\instameme\memes\meme"+str(i_bpt)+".png")
...
time.sleep(1)
insta_driver.find_element_by_name('username').send_keys('your email here')
time.sleep(1)
insta_driver.find_element_by_name('password').send_keys('your password here'+Keys.RETURN)
time.sleep(2)
