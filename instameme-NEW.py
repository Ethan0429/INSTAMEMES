...
reddit_p = praw.Reddit(client_id='yafPiGK4VEX9ig',
						client_secret='h4BtvBZWbpMUh05W06AAUD6HwIw',
						user_agent='txOzTiwgqJ0pzmsyCRP1RkPCzJDMAEfb1Lggwxmd')
...
InstagramAPI = InstagramAPI("echanudainstamemes@gmail.com", "instamemes123")
InstagramAPI.login()  # login

if(memenum not in dankmeme_dict):
	photo_path = r'C:\Users\ethan\Desktop\instameme\memes\\'+random.choice(meme_and_bpt)+str(memenum)+'.jpg'
elif(memenum not in meme_dict):
	photo_path = r'C:\Users\ethan\Desktop\instameme\memes\\'+random.choice(dankmeme_bpt)+str(memenum)+'.jpg'
elif(memenum not in bpt_dict):
	photo_path = r'C:\Users\ethan\Desktop\instameme\memes\\'+random.choice(dankmeme_meme)+str(memenum)+'.jpg'
else:
	photo_path = r'C:\Users\ethan\Desktop\instameme\memes\\'+(meme_index[1])+str(memenum)+'.jpg'
